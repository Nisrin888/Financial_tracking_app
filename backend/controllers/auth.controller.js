 ...
 * Manages all user authentication and authorization workflows.
 * Includes registration, login, logout, token generation/refresh,
 * OAuth (Google), password management, profile updates, and data export.
 */
